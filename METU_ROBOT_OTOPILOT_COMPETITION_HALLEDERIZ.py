...
async def run():
    ...
    tbp = 0.1                                                           # Time interval until next command executes
    ...
    for tours in range(13):                                                                                                         # loop count is sat according to that data. System is looped so drone makes 13 full turns.
        print("first line")
